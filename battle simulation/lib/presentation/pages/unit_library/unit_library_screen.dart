    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 6),
          Text(
            'These cards come from the shared Firebase catalog. Everyone can browse and battle with them, while signed-in admins can update the roster.',
            style: TextStyle(
              color: AppColors.primaryColor,
              fontSize: 13,
              height: 1.35,
    ...
    return Container(
      ...
      child: const Column(
        children: [
          ...
          SizedBox(height: 6),
          Text(
            'No units have been published yet. A signed-in admin can create the first roster entry.',
